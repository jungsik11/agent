...
from cache import KVCache, RotatingKVCache, QuantizedKVCache
...
class Model(nn.Module):
    ...
    def generate(self, x, temp=1.0, repetition_penalty=1.1):
        y = x
        while True:
            logits = self(y)[:, -1, :]
            ...
            for token_id in y[0].tolist(): # Assuming batch size 1 for chat
